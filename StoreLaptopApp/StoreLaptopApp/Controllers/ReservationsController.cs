...
namespace StoreLaptopApp.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            var reservations = db.Reservations.Include(r => r.Customer).Include(r => r.Show);
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerId,ShowId")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerId,ShowId")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
